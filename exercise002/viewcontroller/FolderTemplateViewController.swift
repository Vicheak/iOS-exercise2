...
class FolderTemplateViewController: UIViewController {
    ...
    private func setUpViews(){
        ...
        detailTextView.text = "Enter folder detail"
...
extension FolderTemplateViewController: UITextFieldDelegate, UITextViewDelegate {
    ...
    func textViewDidBeginEditing(_ textView: UITextView) {
        if textView.text == "Enter folder detail" {
            textView.text = ""
